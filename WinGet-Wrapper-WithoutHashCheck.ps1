...
Write-Log "Executing settings --enable InstallerHashOverride"
Start-Process "$WingetPath" -ArgumentList " settings --enable InstallerHashOverride" -WindowStyle Hidden -PassThru -Wait -RedirectStandardOutput "$stdout" -RedirectStandardError "$errout"
...
Write-Log "Executing settings --disable InstallerHashOverride"
Start-Process "$WingetPath" -ArgumentList " settings --disable InstallerHashOverride" -WindowStyle Hidden -PassThru -Wait -RedirectStandardOutput "$stdout" -RedirectStandardError "$errout"
